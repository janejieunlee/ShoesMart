...
<tr>
	...
	<a href="replyForm.do?parentId=${article.id}&p=${param.p}">답변쓰기</a>
	<a href="updateForm.do?articleId=${article.id}&p=${param.p}">수정하기</a>
	<a href="deleteForm.do?articleId=${article.id}">삭제하기</a>
	</td>
</tr>
</table>
</div>
